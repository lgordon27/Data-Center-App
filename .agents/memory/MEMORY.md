...
- [Persisted-state contract drift](persisted-state-contract-drift.md) — normalize restored UI state fail-closed on read and revalidate at the mutation boundary; storage outlives contract changes.