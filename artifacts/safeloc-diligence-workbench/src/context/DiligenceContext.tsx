...
export const INITIAL_EVIDENCE: Record<string, EvidenceItem> = {
  ...
  carbon_compliance: { id: 'carbon_compliance', label: 'Carbon Compliance Cost', value: 20, numericValue: 20, unit: '$M/yr', classification: 'Model Inference', citation: 'Analyst inference from ERCOT grid intensity and on-site natural-gas generation', description: 'Synthetic annual allowance for emissions, offsets, and policy exposure at full campus scale.', sourceId: null, providerSourceId: null, sourceRole: 'Analyst inference' },
  permitting_timeline: { id: 'permitting_timeline', label: 'Core Build Timeline', value: 'Eight-building core targeted for completion in 2026–2027', numericValue: 10, unit: 'Management schedule', classification: 'Management Assertion', citation: 'OpenAI / Oracle announcements and Abilene local project updates', description: 'Public announcements targeted the eight-building core for mid-2026, while later local updates described construction continuing into early 2027.', sourceId: null, providerSourceId: null, sourceRole: 'Project reporting' },
  customer_concentration: { id: 'customer_concentration', label: 'Customer Terms & Concentration', value: 100, numericValue: 100, unit: '% concentrated', classification: 'Verified Evidence', citation: 'Oracle SEC filings and public announcements; Crusoe project disclosures', description: 'The modeled revenue base is concentrated in Oracle under a reported 15-year lease supporting more than 450,000 NVIDIA GB200 GPUs.', sourceId: null, providerSourceId: null, sourceRole: 'Public filing and disclosure' },
  water_rights: { id: 'water_rights', label: 'Local Water Rights & Allocation', value: 'Not disclosed', unit: 'Taylor County facility', classification: 'Missing Evidence', citation: 'No public disclosure as of Aug 2026; Taylor County records reviewed', description: 'No public facility-level disclosure establishes Stargate water rights, allocation seniority, or drought curtailment protection.', sourceId: null, providerSourceId: null, sourceRole: 'Project disclosure' },
  ...
  water_source_resilience: {
    ...
    sourceId: null,
    providerSourceId: null,
    sourceRole: 'Public records and inference',
  },
  downtime_cost: {
    id: 'downtime_cost',
