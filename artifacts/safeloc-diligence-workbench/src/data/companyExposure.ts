  ...
  Amazon: [
    {
      ...
      name: "AWS New Albany / Beech-Miller Road Campus",
      operator: "Amazon",
      location: "New Albany · Licking County · OH",
      capacityMW: 300,
      status: "Operating",
      tier: null,
      tierLabel: "Directory discovery context · review required",
      connectionType: "Developer/Operator",
      description: "Compute Atlas directory context identifies the exact campus; ownership, tenancy, utility, and financial claims still require project-level source validation.",
      kind: "directory",
      relationshipBasis: "operator-derived",
      facility: {
        id: "amazon-data-center-ohio-oh",
